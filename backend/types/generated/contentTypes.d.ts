...
export interface ApiBlogPostBlogPost extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Portal blog posts and announcements';
...
export interface ApiContactSubmissionContactSubmission
  ...
  info: {
    description: 'Contact form submissions captured from the academy site';
...
export interface ApiCourseCourse extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Courses offered by teachers';
    displayName: 'Course';
    pluralName: 'courses';
    singularName: 'course';
  };
...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Course events and sessions';
    displayName: 'Event';
    pluralName: 'events';
    singularName: 'event';
  };
  ...
  attributes: {
    autoConfirmationEnabled: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    course: Schema.Attribute.Relation<'manyToOne', 'api::course.course'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiRegistrationRegistration
  ...
  info: {
    description: 'Student registrations for events';
  ...
  attributes: {
    ...
    event: Schema.Attribute.Relation<'manyToOne', 'api::event.event'> &
      Schema.Attribute.Required;
    lastEmailSentAt: Schema.Attribute.DateTime;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::registration.registration'
...
export interface ApiStudentStudent extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Students who can register for events';
    displayName: 'Student';
    pluralName: 'students';
...
export interface ApiTeacherTeacher extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Teacher profiles and their courses';
    displayName: 'Teacher';
    pluralName: 'teachers';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    email: Schema.Attribute.Email;
    expertiseAreas: Schema.Attribute.JSON;
    fullName: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface PluginIletisimMerkeziConfirmationTemplate
  extends Struct.SingleTypeSchema {
  collectionName: 'iletisim_merkezi_confirmation_templates';
  info: {
    description: 'Etkinlik kayd\u0131 sonras\u0131 otomatik g\u00F6nderilen onay e-postas\u0131 \u015Fablonu';
    displayName: 'Onay E-posta \u015Eablonu';
    pluralName: 'confirmation-templates';
    singularName: 'confirmation-template';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'plugin::iletisim-merkezi.confirmation-template'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'plugin::iletisim-merkezi.confirmation-template': PluginIletisimMerkeziConfirmationTemplate;
