...
const demoCourses = [
  ...
  {
    slug: 'e2e-test-paid-course-checkoutform',
    title: 'E2E Test: Paid Course CheckoutForm',
    summary: 'E2E test fixture for the course application iyzico CheckoutForm path.',
    description: [
      '<p>This fixture is intentionally kept open-ended so testers can submit a course application and exercise the shared payment orchestration path.</p>',
      '<p>The checkout amount is controlled by <strong>COURSE_APPLICATION_PAYMENT_AMOUNT_MINOR</strong> in the backend environment.</p>',
    ].join(''),
    topicArea: 'yazilim-gelistirme',
    level: 'orta',
    targetAudience: 'E2E test users validating paid course applications',
    businessValue: 'Paid course application checkout smoke test fixture.',
    scopeSummary: 'Course application submission, SPL clear outcome, iyzico CheckoutForm handoff, callback finalization.',
    outcomeBullets: 'Application reaches pending_payment; iyzico CheckoutForm renders; successful callback completes the application.',
    teacherSlug: 'demo-elif-demir',
  },
];
...
const demoEvents = [
  ...
  },
  {
    ...
    meetingLink: 'https://zoom.us/j/demo-ai-product-kickoff',
...
const e2eFixtures = [
  ...
  {
    slug: 'e2e-test-paid-checkoutform',
    title: 'E2E Test: Paid CheckoutForm',
    summary: 'E2E test fixture — paid event type, registration open, iyzico CheckoutForm path.',
    ...
    for (const fixture of e2eFixtures) {
      await upsertPublishedDocument(
        ...
        fixture.slug,
        {
          ...
          dailySchedule: fixture.dailySchedule,
          course: null,
        },
        result,
        'events'
