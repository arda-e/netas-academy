  ...
  return (
    <>
      <HeroOverlay
        ...
        secondaryCtaTestId="page.home.hero.cta.catalog"
      />
      ...
      <main className="page-shell" data-testid="page.home">
        <section className="page-section pt-8 sm:pt-10 lg:pt-12">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <ul className="mt-8 grid gap-4 sm:grid-cols-3 sm:gap-6">
              <li className="panel-surface rounded-sm p-5 text-left sm:p-6" data-testid={join('page', 'home', 'value-props', 'card', normalizeKey('Sahada Kanıtlanmış'))}>
              ...
              <li className="panel-surface rounded-sm p-5 text-left sm:p-6" data-testid={join('page', 'home', 'value-props', 'card', normalizeKey('Kuruma Özel'))}>
              ...
              <li className="panel-surface rounded-sm p-5 text-left sm:p-6" data-testid={join('page', 'home', 'value-props', 'card', normalizeKey('Dönüşüm Odaklı'))}>
        ...
        <div className="page-section pt-8 sm:pt-10 lg:pt-12">
          <VisualStorySection {...homeVisualSection} itemTestIdPrefix="page.home.visual-story.item" />
        </div>
      </main>
    </>
  );
