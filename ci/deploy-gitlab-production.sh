...
write_env STRAPI_PUBLIC_URL "${STRAPI_PUBLIC_URL:-https://new.netasacademy.com:1337}"
write_env CLIENT_URL "${CLIENT_URL:-https://new.netasacademy.com}"
write_env FRONTEND_URL "${FRONTEND_URL:-http://127.0.0.1:3000}"
write_env NEXT_PUBLIC_API_URL "${NEXT_PUBLIC_API_URL:-https://new.netasacademy.com:1337}"
