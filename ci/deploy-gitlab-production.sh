...
write_env NEXT_PUBLIC_CLOUDFLARE_TURNSTILE_SITE_KEY "$NEXT_PUBLIC_CLOUDFLARE_TURNSTILE_SITE_KEY"
write_env CLOUDFLARE_TURNSTILE_SECRET_KEY "$CLOUDFLARE_TURNSTILE_SECRET_KEY"
write_env IYZICO_ENVIRONMENT "${IYZICO_ENVIRONMENT:-sandbox}"
write_env IYZICO_API_KEY "$IYZICO_API_KEY"
write_env IYZICO_SECRET_KEY "$IYZICO_SECRET_KEY"
write_env IYZICO_BASE_URL "${IYZICO_BASE_URL:-}"
write_env IYZICO_CALLBACK_URL "$IYZICO_CALLBACK_URL"
write_env IYZICO_WEBHOOK_SECRET "${IYZICO_WEBHOOK_SECRET:-}"
